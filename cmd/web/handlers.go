...
func (app *application) userSignupPost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.NotBlank(form.Name, "name"), "name", "This field cannot be blank")
	form.CheckField(validator.NotBlank(form.Email, "email"), "email", "This field cannot be blank")
	form.CheckField(validator.Matches(form.Email, validator.EmailRX), "email", "This field must be a valid email address")
	form.CheckField(validator.NotBlank(form.Password, "password"), "password", "This field cannot be blank")
...
func (app *application) snippetCreatePost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.NotBlank(form.Title, "title"), "title", "This field cannot be blank")
	form.CheckField(validator.MaxChars(form.Title, 100), "title", "This field cannot be more than 100 characters long")
	form.CheckField(validator.NotBlank(form.Content, "content"), "content", "This field cannot be blank")
